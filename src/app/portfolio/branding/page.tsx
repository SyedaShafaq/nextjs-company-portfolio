...
const Branding = () => {
  return (
    ...
    <Image className='logo-img' src="/istockphoto-1480214929-612x612.jpg"width= "200" height="180" alt="" />
    <Image className='logo-img' src="/istockphoto-1438023500-612x612.jpg " width= "200" height="180"alt="" />
    <Image className='logo-img' src="/istockphoto-1856755778-612x612.jpg"width= "200" height="180" alt="" />
    </div>
    
          
    <div className='logo2-div'>
    
    <Image className='logos-img' src= "/istockphoto-1472421626-612x612.jpg"width= "200" height="180" alt="" />
    ...
    <Image  className='logos-img' src="/istockphoto-1856755269-612x612.jpg  "width= "200" height="180" alt="" />
    </div>
